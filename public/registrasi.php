...
require_once "../classes/PenghuniKost.php"; // ← titik koma bro!
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $user_id = $user->register($username, $password, $role); // ← ambil user_id
    if ($user_id) {
        // simpan data penghuni
        $penghuni = new PenghuniKost($nama, $kamar, $durasi);
        $penghuni->setUserId($user_id); // ← pastikan setter ini ada
        $penghuni->simpan();            // ← pastikan method ini ada
